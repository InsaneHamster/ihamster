...
//#ifndef __APPLE__  //YS to VM: just don't add the file to XCode at all... (or make dependency on libpng and remove cocoa version... but I don't think we should do this)
